...
export const PROPERTIES = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'h-r5', name: 'Standard Double C', price: 950, charges: 200, size: '13m²', available: '2026-06-01', status: 'available', features: '1st floor', images: ['/images/limpertsberg-house-room10.JPG'] },
