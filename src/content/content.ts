...
export const PROPERTIES = [
  {
    ...
    rooms: [
      ...
      { id: 'h-r3', name: 'Superior Double A', price: 1050, charges: 150, size: '16m²', aavailable: 'Indefinite', status: 'occupied', features: '1st floor, Dual windows', images: ['/images/limpertsberg-house-room12.JPG'] },
      ...
      { id: 'h-r5', name: 'Deluxe Double A', price: null, charges: null, size: '15m²', available: 'Indefinite', status: 'occupied', features: '2nd floor', images: ['/images/limpertsberg-house-room22.jpg'] },
      { id: 'h-r6', name: 'Deluxe Double B', price: 1050, charges: 150, size: '16m²', available: 'Indefinite', status: 'occupied', features: '2nd floor', images: ['/images/limpertsberg-house-room22.jpg'] },
  ...
  },
  {
    ...
    description: 'A magnificent three-storey Grand Residence located in the quiet area of Dommeldange Gare, just steps from the train station and with excellent access to Kirchberg (2 min) and the city centre (6 min). \nThe property features nine thoughtfully designed rooms, a spacious shared living area, and a private terrace—creating a comfortable, well-balanced coliving environment ideal for modern professionals.\n\nWith multiple direct train and bus connections, commuting to Kirchberg, the city centre, and major business districts is fast, seamless, and highly convenient.\n\nEach room is fully furnished with high-quality, nearly new furniture, including a double bed, dedicated workspace (desk and chair), large mirrored wardrobe, bedside table, and smart lighting—allowing for a smooth, move-in-ready experience from day one.\n\nThe residence is home to a carefully curated community of young professionals (mid-20s to mid-30s) in a mixed-gender environment, working at leading organisations such as Amazon, major banks, European institutions, Big Four firms, and the public sector.\n\nThe house is currently undergoing continuous upgrades to its common areas and facilities. Rental pricing has been temporarily adjusted to reflect this, and the advertised rate applies for the first four months only.\n\n*Photos of the bathroom and bedroom on the second floor are representative images post-renovation. The same design, furniture, and finishing materials will be installed in your private space.\n\nCommune registration is included.',
    locationHighlights: [
    ...
    amenities: [
      'Fully furnished', '2Gbps fiber internet', 'Weekly professional cleaning', 'Common space more than 100m²', 
      '3 modern bathrooms (1 to be delivered)', 'Smart TV', 'Smart lighting', 'Smart heating system', 'Shutter', 'Washing Machine & Dryer', 
    ...
    rooms: [
      { id: 'h-r1', name: 'Standard Double A', price: 700, charges: 200, size: '13m²', available: 'Indefinite', status: 'occupied', features: 'Ground floor', images: ['/images/dommeldange-room01.JPG'] },
      { id: 'h-r2', name: 'Deluxe Double A', price: 950, charges: 200, size: '15m²', available: '2026-06-01', status: 'available', features: 'Ground floor', images: ['/images/dommeldange-room02.JPG'] },
      { id: 'h-r3', name: 'Standard Double B', price: 750, charges: 200, size: '13m²', available: 'Indefinite', status: 'occupied', features: '1st floor', images: ['/images/limpertsberg-house-room11.JPG'] },
      { id: 'h-r4', name: 'Superior Double', price: 850, charges: 200, size: '18m²', available: 'Indefinite', status: 'occupied', features: '1st floor, Dual windows', images: ['/images/dommeldange-room12.JPG','/images/dommeldange-room12-2.JPG'] },
      { id: 'h-r5', name: 'Standard Double C', price: 750, charges: 200, size: '13m²', available: '2026-06-01', status: 'available', features: '1st floor', images: ['/images/limpertsberg-house-room10.JPG'] },
      { id: 'h-r6', name: 'Deluxe Double B', price: 950, charges: 200, size: '16m²', available: '2026-05-16', status: 'available', features: '2nd floor, Dual windows', images: ['/images/limpertsberg-house-room22.jpg'] },
      { id: 'h-r7', name: 'Deluxe Double C', price: 950, charges: 200, size: '15m²', available: '2026-05-16', status: 'available', features: '2nd floor, Dual windows', images: ['/images/limpertsberg-house-room22.jpg'] },
      { id: 'h-r8', name: 'Standard Double D', price: 900, charges: 200, size: '13m²', available: '2026-05-16', status: 'available', features: '2nd floor, Large skylight window', images: ['/images/limpertsberg-house-room23.JPG'] },
      { id: 'h-r9', name: 'Standard Double E', price: 950, charges: 200, size: '14m²', available: '2026-06-01', status: 'available', features: '2nd floor, Large skylight window', images: ['/images/limpertsberg-house-room23.JPG'] }
    ]
  },
  {
    id: 'bertrange-apt',
