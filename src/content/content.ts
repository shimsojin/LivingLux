...
export const PROPERTIES = [
  ...
  },
  {
    ...
    images: [
      ...
      '/images/dommeldange-livingroom.jpeg',
    ...
    rooms: [
      ...
      { id: 'h-r4', name: 'Superior Double', price: 1000, charges: 150, size: '18m²', available: '2026-08-01', status: 'available', features: '1st floor, Dual windows', images: ['/images/dommeldange-room12.JPG','/images/dommeldange-room12-2.JPG'] },
      ...
      { id: 'h-r7', name: 'Deluxe Double C', price: 900, charges: 200, size: '15m²', available: '2026-07-01', status: 'available', features: '2nd floor, Dual windows', images: ['/images/dommeldange-room22.jpg'] },
      ...
      { id: 'h-r9', name: 'Standard Double E', price: 850, charges: 200, size: '13m²', available: 'Indefinite', status: 'occupied',features: '2nd floor, Panoramic skylight window', images: ['/images/dommeldange-room23.jpg'] }
    ]
  },
  {
    id: 'bertrange-apt',
