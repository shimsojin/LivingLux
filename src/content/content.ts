...
export const PROPERTIES = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'h-r7', name: 'Deluxe Double C', price: 950, charges: 200, size: '13m²', available: '2026-08-01', status: 'available', features: '2nd floor, Dual windows', images: ['/images/dommeldange-room22.jpg'] },
