...
export const PROPERTIES = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'h-r5', name: 'Standard Double C', price: 750, charges: 200, size: '13m²', available: 'Indefinite', status: 'occupied', features: '1st floor', images: ['/images/limpertsberg-house-room10.JPG'] },
