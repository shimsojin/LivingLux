...
export const PROPERTIES = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'h-r9', name: 'Standard Double E', price: 900, charges: 200, size: '13m²', available: '2026-06-01', status: 'available', features: '2nd floor, Panoramic skylight window', images: ['/images/limpertsberg-house-room23.JPG','/images/dommeldange-room24.jpg'] }
    ]
  },
  {
    id: 'bertrange-apt',
