...
export const PROPERTIES = [
  ...
  },
  {
    ...
    images: [
      '/images/limpertsberg-house-bath1.jpg',
      '/images/limpertsberg-house-bath2.jpg',
      '/images/dommeldange-kitchen.jpg',
    ...
    rooms: [
      { id: 'h-r1', name: 'Standard Double A', price: 900, charges: 200, size: '13m²', available: '2026-05-16', status: 'available', features: 'Ground floor', images: ['/images/dommeldange-room01.JPG'] },
      ...
      { id: 'h-r4', name: 'Superior Double', price: 1000, charges: 200, size: '18m²', available: '2026-06-01', status: 'available', features: '1st floor, Dual windows', images: ['/images/dommeldange-room12.JPG','/images/dommeldange-room12-2.JPG'] },
      ...
      { id: 'h-r6', name: 'Deluxe Double B', price: 980, charges: 200, size: '17m²', available: '2026-05-16', status: 'available', features: '2nd floor, Dual windows', images: ['/images/limpertsberg-house-room22.jpg','/images/dommeldange-room24.jpg'] },
      { id: 'h-r7', name: 'Deluxe Double C', price: 950, charges: 200, size: '15m²', available: '2026-05-16', status: 'available', features: '2nd floor, Dual windows', images: ['/images/limpertsberg-house-room22.jpg','/images/dommeldange-room24.jpg'] },
      { id: 'h-r8', name: 'Standard Double D', price: 900, charges: 200, size: '12m²', available: 'Indefinite', status: 'occupied',features: '2nd floor, Panoramic skylight window', images: ['/images/limpertsberg-house-room23.JPG','/images/dommeldange-room24.jpg'] },
      { id: 'h-r9', name: 'Standard Double E', price: 950, charges: 200, size: '13m²', available: '2026-06-01', status: 'available', features: '2nd floor, Panoramic skylight window', images: ['/images/limpertsberg-house-room23.JPG','/images/dommeldange-room24.jpg'] }
    ]
  },
  {
    id: 'bertrange-apt',
