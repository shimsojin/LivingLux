...
export const PROPERTIES = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'h-r6', name: 'Suite Double A', price: 850, charges: 150, size: '12m²', available: '2026-05-01', status: 'available', features: '2nd floor, Dual windows', images: ['/images/limpertsberg-house-room22.jpg'] },
      { id: 'h-r7', name: 'Suite Double B', price: 850, charges: 150, size: '13m²', available: '2026-05-01', status: 'available', features: '2nd floor, Dual windows', images: ['/images/limpertsberg-house-room22.jpg'] },
      { id: 'h-r8', name: 'Suite Double C', price: 850, charges: 150, size: '14m²', available: '2026-05-01', status: 'available', features: '2nd floor, Skylight window', images: ['/images/limpertsberg-house-room23.JPG'] }
    ]
  },
  {
    id: 'bertrange-apt',
